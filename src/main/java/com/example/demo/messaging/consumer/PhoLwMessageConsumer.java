...
import com.example.demo.common.exception.MQProcessingException;
import com.example.demo.common.tools.ApiDevUtils;
import com.example.demo.common.util.XStreamUtil;
import com.example.demo.messaging.support.base.MQConstants;
import com.example.demo.messaging.support.base.MQPersistenceSupport;
...
import com.example.demo.messaging.vo.base.MQMessage;
import com.example.demo.service.SystemServiceSupport;
...
public class PhoLwMessageConsumer {
    ...
    @Autowired
    private SystemServiceSupport systemServiceSupport;
